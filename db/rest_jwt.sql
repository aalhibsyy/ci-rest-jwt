...
--
-- Host: localhost
-- Waktu pembuatan: 23 Apr 2020 pada 02.49
...
INSERT INTO `tbl_barang` (`barang_id`, `barang_nama`, `barang_satuan`, `barang_harpok`, `barang_harjul`, `barang_harjul_grosir`, `barang_stok`, `barang_min_stok`, `barang_tgl_input`, `barang_tgl_last_update`, `barang_kategori_id`) VALUES
('BR000001', 'Kompor', 'Unit', 80000, 100000, 900000, 45, 0, '2020-04-22 17:45:38', NULL, 4);
...
(6, 'Mawar', 'mawar', 'bd117502364227fd8c09098d31e11313', '2', '0');
